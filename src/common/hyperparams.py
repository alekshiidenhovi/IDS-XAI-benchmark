...
def get_xgboost_hyperparams(
    ...
    return XGBoostClassifierConfig(
        ...
        max_depth=cli_kwargs.get("max_depth") or trial.suggest_int("max_depth", 2, 12),
        min_child_weight=cli_kwargs.get("min_child_weight")
        or trial.suggest_int("min_child_weight", 0, 10),
        learning_rate=cli_kwargs.get("learning_rate")
        or trial.suggest_float("learning_rate", 0.001, 0.3),
        subsample=cli_kwargs.get("subsample")
        or trial.suggest_float("subsample", 0.5, 1.0),
        colsample_bytree=cli_kwargs.get("colsample_bytree")
        or trial.suggest_float("colsample_bytree", 0.5, 1.0),
        ...
        or trial.suggest_int("n_estimators", 100, 800),
